...
export default function CompanyContactForm({ formData, emailSent, handleChange, handleSubmit }: CompanyContactFormProps) {
  return (
    <form onSubmit={handleSubmit} className="p-8 bg-white shadow-lg rounded-lg w-full max-w-lg mx-auto">
      <h1 className="text-3xl font-semibold mb-8 text-center text-gray-800">Contact Us</h1>
      <div className="mb-6">
        ...
        <input
          ...
          required
          className="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-lg bg-gray-50"
        />
      </div>
      <div className="mb-6">
