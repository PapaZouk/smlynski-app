            ...
            <main className="max-w-5xl w-full p-6 text-center">
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg">
                    <div className="text-left">
                        <h2 className="text-2xl font-semibold text-gray-900">Szczegóły realizacji</h2>
                        <div className="mt-4 text-gray-600 space-y-2">
                            <p>
                                <strong className="text-gray-900">Miejsce:</strong> {project.localization}
                            </p>
                            <p>
                                <strong className="text-gray-900">Data:</strong> {new Date(project.date).toLocaleDateString()}
                            </p>
                        </div>
